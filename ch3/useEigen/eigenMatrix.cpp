...
int main(){
    ...
    cout<<"sum: "<<matrix33.sum()<<endl;

    cout<<"trace: "<<matrix33.trace() <<endl;
    cout<<"times 10: \n"<< 10 * matrix33<<endl;
    cout<<"inverse: \n"<<matrix33.inverse() <<endl;
    cout<<"det: "<<matrix33.determinant()<<endl;

    SelfAdjointEigenSolver<Matrix3d> eigen_Solver(matrix33.transpose() * matrix33);
